...
namespace System.Web.Routing
{
    ...
    /// </summary>
    public static class ElasticRoutingExtensions
    {
        /// <summary>
        /// A delegate to create a route instance.
        /// </summary>
        /// <param name="url">The URL.</param>
        /// <param name="routeHandler">The route handler.</param>
        /// <param name="constraints">The constraints.</param>
        /// <param name="incomingDefaults">The incoming defaults.</param>
        /// <param name="outgoingDefaults">The outgoing defaults.</param>
        /// <param name="projections">The projections.</param>
        /// <param name="dataTokens">The data tokens.</param>
        /// <returns>Returns an instance of the route.</returns>
        public delegate ElasticRoute RouteCreator(string url, IRouteHandler routeHandler,
        ...
        /// <summary>
        /// The route factory method with is used to create route instances and can be replaced on demand.
        /// </summary>
        public static RouteCreator RouteFactory = CreateDefaultRoute;
        ...
        private static ElasticRoute CreateDefaultRoute(string url, IRouteHandler routeHandler,
            object constraints = null,
            object incomingDefaults = null,
            object outgoingDefaults = null,
            object projections = null,
            object dataTokens = null)
        {
            return new ElasticRoute(url, routeHandler, constraints, incomingDefaults, outgoingDefaults, projections, dataTokens);
        }
    }
}
